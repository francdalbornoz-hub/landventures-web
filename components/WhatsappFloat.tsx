...
export default function WhatsappFloat() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-40 h-14 w-14 rounded-full bg-[#25d366] text-white shadow-lg shadow-black/30 flex items-center justify-center transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] hover:scale-110 hover:shadow-xl hover:shadow-[#25d366]/40 active:scale-95"
    >
      <span className="absolute inset-0 rounded-full bg-[#25d366] animate-ping opacity-20 group-hover:opacity-0 transition-opacity" />
      <svg viewBox="0 0 32 32" className="h-7 w-7 relative z-10" aria-hidden fill="currentColor">
